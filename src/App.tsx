            ...
            <div className="text-white font-semibold  mt-20 text-sm ">
              <ol className="list-decimal list-outside px-[2rem] sm:max-w-[80%] md:max-w-screen space-y-10 mx-auto  ">
                <li className="">
                  ...
                  <img src="/tutorial/1.png" className="w-100 lg:w-130 lg:h-70 mt-2 md:ml-4" alt="" />
                  <img src="/tutorial/2.png" className="w-100 lg:w-130 lg:h-70 mt-2 md:ml-4" alt="" />
                  </div>
                </li>
                <li className="mt-20">
                  ...
                  <div className="flex flex-col md:flex-row">
                  <img src="/tutorial/3.png" className="w-100 lg:w-130 lg:h-90 mt-2 md:ml-4" alt="" />
                  <img src="/tutorial/5.png" className="w-100 lg:w-100 lg:h-90 mt-2 md:ml-4 md:ml-20" alt="" />
                ...
                <li className="mt-20">
                  ...
                  <div className="flex flex-col md:flex-row">
                  <img src="/tutorial/4.png" className="w-100 lg:w-130 lg:h-80 mt-2 md:ml-4" alt="" />
                  <img src="/tutorial/6.png" className="w-100 lg:w-130 h-20 lg:h-30 mt-2 md:ml-4" alt="" />
                  </div>
                </li>
                <li className="mt-20">
                  ...
                  <div className="flex flex-col md:flex-row">
                  <img src="/tutorial/7.png" className="w-100 lg:w-130 lg:h-90 mt-2 md:ml-4" alt="" />
                  <img src="/tutorial/8.png" className="w-100 lg:w-130 h-40 lg:h-50 mt-2 md:ml-4" alt="" />
                  </div>
                </li>
                <li className="mt-20">
                  ...
                  <div className="flex flex-col md:flex-row">
                  <img src="/tutorial/9.png" className="w-100 lg:w-130 md:h-10 mt-2 md:ml-4" alt="" />
                  <img src="/tutorial/10.png" className="w-100 lg:w-130 lg:h-60 mt-2 md:ml-4" alt="" />
                  </div>
                </li>
                <li className="mt-20">
                  {lang === "en" ? "Check Address List" : "Cek Address List"}
                  <div className="flex flex-col md:flex-row">
                  <img src="/tutorial/11.png" className="w-100 lg:w-130 lg:h-80 mt-2 md:ml-4" alt="" />
                  <img src="/tutorial/11.1.png" className="w-100 lg:w-130 lg:h-80 mt-2 md:ml-4" alt="" />
                  </div>
                </li>
                <li className="mt-20">
                  ...
                  <img src="/tutorial/12.png" className="w-100 lg:w-130 h-80 lg:h-80 mt-2 md:ml-4" alt="" />
                  <img src="/tutorial/13.png" className="w-100 lg:w-130 h-80 lg:h-80 mt-2 md:ml-4" alt="" />
                  <img src="/tutorial/14.png" className="w-100 lg:w-130 h-80 lg:h-80 mt-2 md:ml-4" alt="" />
                  </div>
                </li>
                <li className="mt-20">
                  {lang === "en" ? "Result" : "Hasil"}
                  <div className="flex flex-col md:flex-row">
                  <img src="/tutorial/16.png" className="w-100 lg:w-130 md:h-10 mt-2 md:ml-4" alt="" />
                  <img src="/tutorial/15.png" className="w-100 lg:w-130 lg:h-80 mt-1 md:ml-4" alt="" />
                  </div>
                </li>
              </ol>
            </div>
